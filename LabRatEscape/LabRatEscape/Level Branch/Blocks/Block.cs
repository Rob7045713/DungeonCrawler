...
namespace LabRatEscape
{
    ...
    public class Block : Sprite
    {
        ...
        internal float effectTimer = 0;
        internal float effectDelay;
        ...
        {
            Block block = new Block(id, spriteSheet, position, effects, onStep, activePassability, inactivePassability,
        ...
        {
            if (effects != null && effectTimer > effectDelay)
            {
                effectTimer = 0;
