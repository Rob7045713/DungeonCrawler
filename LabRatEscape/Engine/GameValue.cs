...
namespace LabRatEscape
{
    ...
    public class GameValue
    {
        ...
        /// <param name="maxValue">The largest allowed value</param>
        /// <param name="step">The step of allowed values (value is restriced to 0 +/- n * step)</param>
        /// <param name="wrap">If the value wraps around at min and max</param>
        public GameValue(decimal initialValue, decimal minValue, decimal maxValue, decimal step, bool wrap)
        {
            this.initialValue = initialValue;
            this.value = initialValue;
            this.minValue = minValue;
